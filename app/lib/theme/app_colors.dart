...
class AppColors {
  ...
  // Brand & Accent Colors
  static const Color primary = Color(0xFFD32F2F);      // User requested #D32F2F (red for crisis)
  static const Color secondary = Color(0xFFFF8A00);    // Bright Amber/Yellow
  static const Color tertiary = Color(0xFF1976D2);     // Deep Blue for Orchestrator Logic
